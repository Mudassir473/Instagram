            ...
            <div class="modal-right-section">
                <div class="user-top-info">
                    <div class="user-profile-info">
                        <a class="pjax" href="<?php echo e(route('profile.show',$video->user->slug)); ?>" onclick="profileshow()"> <img src="<?php echo e(asset($video->user->image)); ?>" alt=""> <?php echo e($video->user->username); ?></a>
                    </div>
                ...
                <div class="send-comment-area">
                    ...
                    <form action="<?php echo e(route('comment')); ?>" method="POST" id="comment_send">
                        ...
                        <div class="d-flex">
                            ...
                            <button type="submit"><?php echo e(__('Post')); ?></button>
                        </div>
                    </form>
                    <?php else: ?>
...
<script src="<?php echo e(asset('frontend/js/modal/modal.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\newtong\script\resources\views/modal.blade.php ENDPATH**/ ?>