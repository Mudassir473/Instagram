...
<?php $__env->startSection('title','Manage User Reports'); ?>
							...
							<div class="table-responsive">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>
											<a target="__blank" href="<?php echo e(route('profile.show',App\User::find($report->parent_id)->slug)); ?>" class="btn btn-primary">View</a>
