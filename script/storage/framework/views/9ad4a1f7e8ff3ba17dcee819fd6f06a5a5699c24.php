                ...
                <div class="col-lg-3">
                    <div class="header-right-section f-right">
                        ...
                        <div class="upload-btn">
                            <?php if(Session::has('mode')): ?>
                            <?php if(Session::get('mode')['id'] == 'night'): ?>
                             <a class="pjax" href="<?php echo e(route('upload')); ?>"><img id="upload_mode" class="upload" src="<?php echo e(asset('frontend/img/white_upload.png')); ?>" alt=""></a>
                            <?php else: ?>
                             <a class="pjax" href="<?php echo e(route('upload')); ?>"><img id="upload_mode" class="upload" src="<?php echo e(asset('frontend/img/upload.png')); ?>" alt=""></a>
                            <?php endif; ?>
                            <?php else: ?>
                             <a class="pjax" href="<?php echo e(route('upload')); ?>"><img id="upload_mode" class="upload" src="<?php echo e(asset('frontend/img/upload.png')); ?>" alt=""></a>
                            <?php endif; ?>
                        ...
                        <div class="profile-seeting">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <a href="<?php echo e(route('settings')); ?>" class="pjax dropdown-item"><?php echo e(__('Settings')); ?></a>
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="btn login-btn pjax"><?php echo e(__('Login')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\newtong\script\resources\views/layouts/frontend/partials/header.blade.php ENDPATH**/ ?>