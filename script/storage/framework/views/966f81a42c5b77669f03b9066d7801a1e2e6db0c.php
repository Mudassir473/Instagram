...
<?php $__env->startSection('title','Create Ads'); ?>
...
<div class="main-content">
	<section class="section">
		<div class="section-header">
			<h1><?php echo e(__('Create Ads')); ?></h1>
			<div class="section-header-breadcrumb">
				<div class="breadcrumb-item active"><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></div>
				<div class="breadcrumb-item"><?php echo e(__('Create Ads')); ?></div>
			</div>
		</div>

		<div class="section-body">
			<h2 class="section-title"><?php echo e(__('Create Ads')); ?></h2>
			<p class="section-lead"><?php echo e(__('Create Ads Section')); ?></p>
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<h4><?php echo e(__('Create Ads')); ?></h4>
							<form action="<?php echo e(route('admin.ads.store')); ?>" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<select class="form-control selectric" name="pricing" id="ads_pricing">
            							<option value="per_link" selected><?php echo e(__('Per Click')); ?></option>
            							<option value="per_impression"><?php echo e(__('Per Impression')); ?></option>
            						</select>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="number" name="total_limit" class="form-control">
								</div>
