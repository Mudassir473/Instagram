                ...
                <div class="col-lg-12">
                	<div class="ads-content-area">
                		...
                		<div class="ads-header d-flex">
                			<h4><i class="fab fa-adn ads"></i> <span class="ads"><?php echo e(__('
                		Advertising > Create Advertising')); ?></span></h4>
                			<h4><i class="far fa-credit-card"></i> <?php echo e(__('Wallet')); ?>(<?php echo e($currency_value->symbol); ?><?php echo e(number_format($user_data->wallet,2)); ?>)</h4>
                		</div>
                		<input type="hidden" id="ads_url" value="<?php echo e(route('ads.index')); ?>">
                		<div class="create-ads-area">
                			<form action="<?php echo e(route('ads.store')); ?>" class="create-ads-form" id="ads_form" method="POST">
                				<?php echo csrf_field(); ?>
                				<div class="row">
	                				<div class="col-lg-8">
	                					<h6><?php echo e(__('Title')); ?></h6>
	                					<div class="login-form-group">
	                						<input type="text" name="title" class="login-form-control" placeholder="<?php echo e(__('Title')); ?>">
	                					</div>
	                					<h6><?php echo e(__('Url')); ?></h6>
	                					<div class="login-form-group">
	                						<input type="text" name="url" class="login-form-control" placeholder="<?php echo e(__('Url')); ?>">
	                					</div>
	                				...
	                				<div class="col-lg-4">
	                					...
	                					<div class="login-form-group">
	                						<select class="login-form-control" name="pricing" id="ads_pricing">
	                							<option value="per_link" selected><?php echo e(__('Pay per link')); ?>(<?php echo e($currency_value->symbol); ?><?php echo e($per_link->value); ?>)</option>
	                							<option value="per_impression"><?php echo e(__('Pay per Impression')); ?>(<?php echo e($currency_value->symbol); ?><?php echo e($per_impression->value); ?>)</option>
	                						</select>
	                					</div>
