            ...
            <div class="modal-right-section">
                ...
                <div class="modal-video-post-action">
                    <div class="modal-main-action">
                        ...
                        @if(Auth::check())
                        <a href="javascript:void(0)" class="f-right" onclick="report('{{ $video->slug }}')"><i class="far fa-flag"></i></a>
                        @else
                        <a href="{{ route('login') }}" class="pjax f-right" onclick="profileshow()"><i class="far fa-flag"></i></a>
                        @endif
                    </div>
